...
const Blog = () => {
    return (
        <div className='mx-4 md:mx-0'>
            ...
            <div>
                <h3 className='text-xl mt-8 text-green-600'>What is the purpose of React Router?</h3>
            ...
            <div>
                <h3 className='text-xl mt-8 text-green-600'>How does Context API work?</h3>
            ...
            <div>
                <h3 className='text-xl mt-8 text-green-600'>Write about use ref()</h3>
